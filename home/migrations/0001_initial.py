# Generated by Django 4.1.12 on 2024-05-20 01:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(choices=[('1st', '1st'), ('2nd', '2nd'), ('Summer', 'Summer')], default='1st', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pre_requisit1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subject_prereq1', to='home.subject')),
                ('pre_requisit2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subject_prereq2', to='home.subject')),
                ('pre_requisit3', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subject_prereq3', to='home.subject')),
                ('pre_requisit4', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subject_prereq4', to='home.subject')),
                ('pre_requisit5', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subject_prereq5', to='home.subject')),
        ...
        migrations.AddField(
            model_name='course',
            name='department',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_department_name', to='home.department'),
        ),
        migrations.CreateModel(
            name='Class_Schedule',
            fields=[
